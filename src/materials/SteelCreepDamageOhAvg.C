...
#include "SteelCreepDamageOhAvg.h"
...
registerMooseObject("BlackBearApp", ADSteelCreepDamageOhAvg);

template <bool is_ad>
InputParameters
SteelCreepDamageOhAvgTempl<is_ad>::validParams()
{
...
template <bool is_ad>
SteelCreepDamageOhAvgTempl<is_ad>::SteelCreepDamageOhAvgTempl(const InputParameters & parameters)
...
template <bool is_ad>
void
SteelCreepDamageOhAvgTempl<is_ad>::initQpStatefulProperties()
{
...
template class SteelCreepDamageOhAvgTempl<true>;
